...
public class ComplexMatrix {
    ...
    public static ComplexMatrix extractRows(ComplexMatrix A, int row0, int row1, ComplexMatrix out) {
        if (out == null) {
            return new ComplexMatrix(CommonOps_DSCC.extractRows(A.real.asCSC(), row0, row1, null), CommonOps_DSCC.extractRows(A.im.asCSC(), row0, row1, null));
        } else {
            CommonOps_DSCC.extractRows(A.real.asCSC(), row0, row1, out.real.asCSC());
            CommonOps_DSCC.extractRows(A.im.asCSC(), row0, row1, out.im.asCSC());
            return out;
        }
    }
