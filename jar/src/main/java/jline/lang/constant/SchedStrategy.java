...
public enum SchedStrategy {
    ...
    /** Fair Sojourn Protocol - preemptive; ranks by virtual PS finish time. Dominates PS per-job and approaches SRPT mean response time without starving large jobs */
    FSP,
    ...
    public static String toFeature(SchedStrategy scheduling) {
        switch (scheduling) {
            ...
            case FSP:
                return "SchedStrategy_FSP";
            case PAS:
                return "SchedStrategy_PAS";
            case OI:
                return "SchedStrategy_OI";
            default:
                return "";
        }
    }
