...
public enum MetricType implements Serializable {
    ...
    public static MetricType toMetricType(String desc) {
        switch (desc) {
            ...
            case "Queue Time":
                return QueueT;
            case "FCR Capacity":        // JMT measure name for weighted occupation (Total Weight)
            case "FCR Total Weight":    // internal/legacy alias
                return FCRWeight;
            case "FCR Memory":          // JMT measure name for memory occupation
            case "FCR Memory Occupation":  // internal/legacy alias
                return FCRMemOcc;
