        ...
        for (int m = 0; m < models.size(); m++) {
            ...
            for (Node oldNode : nodes) {
                ...
                if (oldNode instanceof Source) {
                    ...
                    // hasFiniteCap(), not getCap() < MAX_VALUE: a JMT-imported station
                    // carries cap = -1 ("unlimited"), which the bare comparison would
                    // copy verbatim into the clone as a spurious capacity of -1.
                    if (oldQueue.hasFiniteCap()) {
