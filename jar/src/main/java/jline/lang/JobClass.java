...
public class JobClass extends NetworkElement implements Serializable {
    ...
    /**
     * Sets the spawn class index (1-based). On each service completion of a
     * job of this class, a new job of the spawn class is injected at the same
     * station. Used for LQN phase-2 continuations.
     *
     * @param spawnClassIndex 1-based index of the class to spawn
     */
    public void setSpawnClassIndex(int spawnClassIndex) {
        this.spawnClassIndex = spawnClassIndex;
    }

    /**
     * Gets the 1-based index of the spawn class, or -1 if none.
     *
     * @return the 1-based spawn class index, or -1
     */
    public int getSpawnClassIndex() {
        return this.spawnClassIndex;
    }
