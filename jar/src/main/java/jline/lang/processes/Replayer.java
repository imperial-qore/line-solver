...
public class Replayer extends Distribution {
    ...
    public Replayer(Object data) {
        ...
        if (data instanceof String) {
            ...
            // Leaving this.data null would defer the failure to the first metric
            // call, where the cause is no longer visible.
            line_error(mfilename(new Object() {
            }), "Replayer accepts a trace file name, a Matrix, or a double[], but got "
