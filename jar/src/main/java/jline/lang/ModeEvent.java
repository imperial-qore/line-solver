...
public class ModeEvent implements Serializable {
    ...
    public double prob;
    public Matrix state; // state information when the event occurs (optional)
    public double t; // timestamp when the event occurs (optional)
    public double job; // job id (optional)
