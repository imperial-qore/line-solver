...
public final class MAPFromRAP {
    ...
    public static Pair<Matrix, Matrix> mapFromRAP(Matrix H0, Matrix H1, double prec) {
        if (!CheckRAPRepresentation.checkRAPRepresentation(H0, H1, prec)) {
            throw new IllegalArgumentException("MAPFromRAP: Input isn't a valid RAP representation!");
        }
