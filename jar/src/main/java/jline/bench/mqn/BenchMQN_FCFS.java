 ...
 * Aligned with MATLAB benchmarks: bench_MQN_FCFS_*.m
 */
public class BenchMQN_FCFS {
    ...
    public static void runLightLoad(int iteration) {
        BenchMQNTemplate.runBenchmark("bench_MQN_FCFS_lightload", iteration, LIGHT_LOAD, LOW_POP, SchedStrategy.FCFS);
    }
    ...
    public static void runMidLoad(int iteration) {
        BenchMQNTemplate.runBenchmark("bench_MQN_FCFS_midload", iteration, MID_LOAD, LOW_POP, SchedStrategy.FCFS);
    }
    ...
    public static void runHighLoad(int iteration) {
        BenchMQNTemplate.runBenchmark("bench_MQN_FCFS_highload", iteration, HIGH_LOAD, LOW_POP, SchedStrategy.FCFS);
    }
    ...
    public static void runHipopLightLoad(int iteration) {
        BenchMQNTemplate.runHighPopBenchmark("bench_MQN_FCFS_hipop_lightload", iteration,
                LIGHT_LOAD, HIGH_POP, SchedStrategy.FCFS);
    }
    ...
    public static void runHipopMidLoad(int iteration) {
        BenchMQNTemplate.runHighPopBenchmark("bench_MQN_FCFS_hipop_midload", iteration,
                MID_LOAD, HIGH_POP, SchedStrategy.FCFS);
    }
    ...
    public static void runHipopHighLoad(int iteration) {
        BenchMQNTemplate.runHighPopBenchmark("bench_MQN_FCFS_hipop_highload", iteration,
                HIGH_LOAD, HIGH_POP, SchedStrategy.FCFS);
    }
    ...
    public static void runTandemLightLoad(int iteration) {
        BenchMQNTemplate.runTandemBenchmark("bench_MQN_FCFS_tandem_lightload", iteration,
                LIGHT_LOAD, LOW_POP, SchedStrategy.FCFS);
    }
    ...
    public static void runTandemMidLoad(int iteration) {
        BenchMQNTemplate.runTandemBenchmark("bench_MQN_FCFS_tandem_midload", iteration,
                MID_LOAD, LOW_POP, SchedStrategy.FCFS);
    }
    ...
    public static void runTandemHighLoad(int iteration) {
        BenchMQNTemplate.runTandemBenchmark("bench_MQN_FCFS_tandem_highload", iteration,
                HIGH_LOAD, LOW_POP, SchedStrategy.FCFS);
    }
