 ...
 * Aligned with MATLAB benchmarks: bench_OQN_FCFS_*.m
 */
public class BenchOQN_FCFS {
    ...
    public static void runLightLoad(int iteration) {
        BenchOQNTemplate.runBenchmark("bench_OQN_FCFS_lightload", iteration, LIGHT_LOAD, SchedStrategy.FCFS);
    }
    ...
    public static void runMidLoad(int iteration) {
        BenchOQNTemplate.runBenchmark("bench_OQN_FCFS_midload", iteration, MID_LOAD, SchedStrategy.FCFS);
    }
    ...
    public static void runHighLoad(int iteration) {
        BenchOQNTemplate.runBenchmark("bench_OQN_FCFS_highload", iteration, HIGH_LOAD, SchedStrategy.FCFS);
    }
    ...
    public static void runMulticlassLightLoad(int iteration) {
        BenchOQNTemplate.runMulticlassBenchmark("bench_OQN_FCFS_multiclass_lightload", iteration,
                0.15, 0.15, SchedStrategy.FCFS);
    }
    ...
    public static void runMulticlassMidLoad(int iteration) {
        BenchOQNTemplate.runMulticlassBenchmark("bench_OQN_FCFS_multiclass_midload", iteration,
                0.3, 0.3, SchedStrategy.FCFS);
    }
    ...
    public static void runMulticlassHighLoad(int iteration) {
        BenchOQNTemplate.runMulticlassBenchmark("bench_OQN_FCFS_multiclass_highload", iteration,
                0.45, 0.45, SchedStrategy.FCFS);
    }
    ...
    public static void runTandemLightLoad(int iteration) {
        BenchOQNTemplate.runTandemBenchmark("bench_OQN_FCFS_tandem_lightload", iteration,
                LIGHT_LOAD, SchedStrategy.FCFS);
    }
    ...
    public static void runTandemMidLoad(int iteration) {
        BenchOQNTemplate.runTandemBenchmark("bench_OQN_FCFS_tandem_midload", iteration,
                MID_LOAD, SchedStrategy.FCFS);
    }
    ...
    public static void runTandemHighLoad(int iteration) {
        BenchOQNTemplate.runTandemBenchmark("bench_OQN_FCFS_tandem_highload", iteration,
                HIGH_LOAD, SchedStrategy.FCFS);
    }
