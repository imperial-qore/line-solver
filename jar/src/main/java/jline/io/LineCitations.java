/**
 * @file Bibliographic references for the algorithms LINE uses
 *
 * @since LINE 3.0
 */
package jline.io;
 ...
 *
 * <p>Port of matlab/src/io/line_citations.m; python twin
 * line_solver.api.io.citations. The table is the manual's method-to-citation
 * mapping (doc/latex/manual.tex) and its bibliography (doc/latex/biblio.bib);
 * keep the three in step, and add an entry whenever a solver method or
 * approximation is added.
 *
 * <p>Attribution in LINE is pull-based: nothing is printed during a solve, and
 * a user asks for the references with solver.citations() when writing them up.
 */
public final class LineCitations {
    private LineCitations() {}
    ...
    public static class Citation {
        ...
        public Citation(String key, String ref, String covers) {
            this.key = key;
            this.ref = ref;
            this.covers = covers;
        }
    ...
    private static final Map<String, Citation> REGISTRY = new HashMap<String, Citation>();

    private static void add(String token, String key, String ref, String covers) {
        REGISTRY.put(token, new Citation(key, ref, covers));
    }
    ...
    static {
        ...
        add("amva.fli", "WangS00",
            "H. Wang, K. C. Sevcik, \"Experiments with improved approximate mean value analysis algorithms\", Perform. Eval. 39, 2000",
            "improved AMVA arrival-instant estimators");
        add("qli", "WangS00",
            "H. Wang, K. C. Sevcik, \"Experiments with improved approximate mean value analysis algorithms\", Perform. Eval. 39, 2000",
            "improved AMVA arrival-instant estimators");
        add("amva.qli", "WangS00",
            "H. Wang, K. C. Sevcik, \"Experiments with improved approximate mean value analysis algorithms\", Perform. Eval. 39, 2000",
            "improved AMVA arrival-instant estimators");
        add("conway", "Con89",
        ...
        add("aba.upper", "BolGMT06",
            "G. Bolch, S. Greiner, H. de Meer, K. S. Trivedi, \"Queueing Networks and Markov Chains\", Wiley, 2006",
            "asymptotic bounds on throughput and response time");
        add("aba.lower", "BolGMT06",
            "G. Bolch, S. Greiner, H. de Meer, K. S. Trivedi, \"Queueing Networks and Markov Chains\", Wiley, 2006",
            "asymptotic bounds on throughput and response time");
        add("bjb", "CasMS08",
        ...
        add("pb", "CasMS08",
            "G. Casale, R. R. Muntz, G. Serazzi, \"Geometric Bounds: A Noniterative Analysis Technique for Closed Queueing Networks\", IEEE TC 57(6), 2008",
            "geometric and balanced-job bounds");
        add("bjb.upper", "CasMS08",
            "G. Casale, R. R. Muntz, G. Serazzi, \"Geometric Bounds: A Noniterative Analysis Technique for Closed Queueing Networks\", IEEE TC 57(6), 2008",
            "geometric and balanced-job bounds");
        add("bjb.lower", "CasMS08",
            "G. Casale, R. R. Muntz, G. Serazzi, \"Geometric Bounds: A Noniterative Analysis Technique for Closed Queueing Networks\", IEEE TC 57(6), 2008",
            "geometric and balanced-job bounds");
        add("gb.upper", "CasMS08",
            "G. Casale, R. R. Muntz, G. Serazzi, \"Geometric Bounds: A Noniterative Analysis Technique for Closed Queueing Networks\", IEEE TC 57(6), 2008",
            "geometric and balanced-job bounds");
        add("gb.lower", "CasMS08",
            "G. Casale, R. R. Muntz, G. Serazzi, \"Geometric Bounds: A Noniterative Analysis Technique for Closed Queueing Networks\", IEEE TC 57(6), 2008",
            "geometric and balanced-job bounds");
        add("pb.upper", "CasMS08",
            "G. Casale, R. R. Muntz, G. Serazzi, \"Geometric Bounds: A Noniterative Analysis Technique for Closed Queueing Networks\", IEEE TC 57(6), 2008",
            "geometric and balanced-job bounds");
     ...
     * @return one entry per distinct paper, in the order the tokens were given
     */
    public static List<Citation> citationsFor(List<String> tokens) {
        List<Citation> out = new ArrayList<Citation>();
        ...
        for (String token : tokens) {
            ...
            Citation c = REGISTRY.get(t);
            if (c == null && t.indexOf('.') >= 0) {
                c = REGISTRY.get(t.substring(t.indexOf('.') + 1));
            }
            if (c == null || seen.contains(c.key)) {
                continue;
            }
            seen.add(c.key);
            out.add(c);
