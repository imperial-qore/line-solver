...
public final class Ms_additivesymmetricchisquared {
    private Ms_additivesymmetricchisquared() {}
     ...
     */
    public static double ms_additivesymmetricchisquared(Matrix P, Matrix Q) {
