 ...
 * @since LINE 3.1.0
 */
public final class Dqsys_geogeo1 {
    private Dqsys_geogeo1() {}
     ...
     */
    public static GeoGeo1Result dqsys_geogeo1(double a, double s) {
        return dqsys_geogeo1(a, s, GeoGeo1Convention.LAS_DA);
    }
     ...
     * @return the stationary metrics
     */
    public static GeoGeo1Result dqsys_geogeo1(double a, double s, GeoGeo1Convention convention) {
        if (convention == null) {
