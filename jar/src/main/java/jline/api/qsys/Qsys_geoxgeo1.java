 ...
 *
 * <p>Generalizes {@link Qsys_geogeo1} from single to batch arrivals. In every
 ...
 * result, so {@link Qsys_geogeo1} is the degenerate-batch special case. The
 ...
 * @since LINE 3.1.0
 */
public final class Qsys_geoxgeo1 {
    private Qsys_geoxgeo1() {}
    ...
    public static GeoXGeo1Result qsys_geoxgeo1(double a, double beta, double s) {
        return qsys_geoxgeo1(a, beta, s, GeoGeo1Convention.LAS_DA);
    }
     ...
     * always a single job and the result equals {@link Qsys_geogeo1}.
     *
    ...
    public static GeoXGeo1Result qsys_geoxgeo1(double a, double beta, double s,
        ...
        return qsys_geoxgeo1_moments(a, batchMean, batchSecondFactorial, s, convention);
    }
     ...
     * @return the stationary metrics
     */
    public static GeoXGeo1Result qsys_geoxgeo1_moments(double a, double batchMean,
