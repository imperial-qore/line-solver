 ...
 * 
 * Fits MMPP(2) using optimization-based approximation methods for count statistics.
 * Advanced fitting approach using numerical optimization for parameter estimation.
 * 
 * @since LINE 3.0
 */
