 ...
 */
public class OQNResultsFormatter {
     ...
     */
    public static class OQNBenchmarkResult {
        ...
        public OQNBenchmarkResult(String benchmarkName, Map<String, Object> results) {
     ...
     */
    public static class OQNResultsAccumulator {
        private List<OQNBenchmarkResult> results = new ArrayList<>();
        private boolean headerPrinted = false;

        public void addResult(String benchmarkName, Map<String, Object> benchmarkResults) {
            results.add(new OQNBenchmarkResult(benchmarkName, benchmarkResults));
        }
        ...
        public void printResults() {
            ...
            Map<String, List<OQNBenchmarkResult>> groupedResults = new java.util.LinkedHashMap<>();
            for (OQNBenchmarkResult result : results) {
            ...
            for (Map.Entry<String, List<OQNBenchmarkResult>> entry : groupedResults.entrySet()) {
                String benchmarkName = entry.getKey();
                List<OQNBenchmarkResult> iterations = entry.getValue();
        ...
        private void printAveragedBenchmarkResult(String benchmarkName, List<OQNBenchmarkResult> iterations) {
        ...
        private Map<String, Double> averageErrors(List<OQNBenchmarkResult> iterations,
                                                   java.util.function.Function<OQNBenchmarkResult, Map<String, Double>> errorGetter) {
            ...
            for (String solverName : SOLVER_ORDER) {
                ...
                for (OQNBenchmarkResult result : iterations) {
    ...
    private static final OQNResultsAccumulator globalAccumulator = new OQNResultsAccumulator();
    ...
    public static void printImmediateResult(String benchmarkName, Map<String, Object> results) {
        OQNResultsAccumulator tempAccumulator = new OQNResultsAccumulator();
        tempAccumulator.addResult(benchmarkName, results);
        tempAccumulator.printResults();
    }

    public static OQNResultsAccumulator createAccumulator() {
        return new OQNResultsAccumulator();
    }
}
