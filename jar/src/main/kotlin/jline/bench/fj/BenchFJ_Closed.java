...
/**
 * Benchmark for Fork-Join Closed Networks
...
public class BenchFJ_Closed {
    ...
    public static void runHomogeneousFCFS() {
        System.out.println("\n=== Running FJ Closed Homogeneous FCFS Benchmarks ===");
    ...
    public static void runHomogeneousPS() {
        System.out.println("\n=== Running FJ Closed Homogeneous PS Benchmarks ===");
    ...
    public static void runHeterogeneousFCFS() {
        System.out.println("\n=== Running FJ Closed Heterogeneous FCFS Benchmarks ===");
    ...
    public static void runHeterogeneousPS() {
        System.out.println("\n=== Running FJ Closed Heterogeneous PS Benchmarks ===");
    ...
    private static BenchmarkResult runBenchmark(String variant, int iteration, 
        ...
        String benchName = "bench_FJ_c_" + variant + "_" + iteration;
        System.out.println("\nRunning " + benchName);
        ...
        // Create job classes - always 2 classes with 10 jobs each
        ClosedClass class1 = new ClosedClass(model, "class1", 10, delay);
        ClosedClass class2 = new ClosedClass(model, "class2", 10, delay);
