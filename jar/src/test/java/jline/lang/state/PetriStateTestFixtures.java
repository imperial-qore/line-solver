...
public class PetriStateTestFixtures {
    ...
    /**
     * Same as {@link #createTestModelMode1TwoServers()} but with a population of 2,
     * so that the marking can shrink below the number of already-running mode1
     * servers (exercises the "running_m &gt; en_degree_m" branch of ENABLE: stop
     * excess servers).
     */
    public static Network createTestModelMode1TwoServersPop2() {
        Network model = new Network("model");
