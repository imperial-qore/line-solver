...
public class OpenExamplesTest {
    ...
    public void testOqnBasicSSA() {
        ...
        // Order: Delay(Class1), Queue1(Class1), Source(Class1)
        double[] expectedQLen = {0.021778265119715312, 0.1201847780991422, 0.0};
        double[] expectedUtil = {0.021778265119715312, 0.1053665877205636, 0.0};
        double[] expectedRespT = {0.21364574966889127, 1.140634623357805, 0.0};
        double[] expectedResidT = {0.21364574966889127, 1.140634623357805, 0.0};
        double[] expectedArvR = {0.10000000000000006, 0.10193633691972494, 0.0};
        double[] expectedTput = {0.10193633691972494, 0.1053665877205636, 0.10000000000000006};
    ...
    public void testOqnCsRoutingSSA() {
        ...
        double[] expectedQLen = {0.0, 0.0, 1.330280888712597, 0.9953581047096152, 0.8449043666727664};
        double[] expectedUtil = {0.0, 0.0, 0.4021067957726861, 0.30115970462495806, 0.4612421835497417};
        double[] expectedRespT = {0.0, 0.0, 0.6616555117688537, 0.9915251835724977, 0.2747703040202271};
        double[] expectedResidT = {0.0, 0.0, 0.4411036745125692, 0.3305083945241658, 0.27477030402022723};
        double[] expectedArvR = {0.0, 0.0, 2.0, 1.0, 3.014399660945125};
        double[] expectedTput = {2.0, 1.0, 2.010533978861986, 1.003865682083139, 3.0749478903315874};
