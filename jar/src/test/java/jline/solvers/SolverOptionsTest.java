...
public class SolverOptionsTest {
    ...
    public void testSolverOptionsDefaults() {
        // Test that default values are set correctly. The default verbose level is
        // inherited from GlobalConstants at construction, so force STD around the
        // construction to keep this check hermetic under the suite-wide SILENT test
        // harness (see jline.testutil.LineVerboseSilencer / -Djline.verbose=SILENT).
        VerboseLevel savedVerbose = GlobalConstants.Verbose;
        ...
        assertEquals(1000, options.iter_max); // base default aligned with MATLAB SolverOptions.m (iter_max=1000)
