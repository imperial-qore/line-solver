...
/**
 * Test suite for customer impatience features in the LDES solver.
 *
 * Tests cover:
 ...
 * @see DropStrategy
 */
public class SolverLDESImpatienceTest {
    ...
    class RetrialTests {
        ...
        public void testRetrialUnlimited() {
            ...
            assertEquals(0.0, dropped, COARSE_TOL, "No customers should be dropped with unlimited retrial");
        }
    ...
    class EdgeCaseTests {
        ...
        public void testNoImpatienceConfigured() {
            ...
            if (result.renegedCustomers != null) {
                double reneged = result.renegedCustomers.get(1, 0);
                assertEquals(0.0, reneged, COARSE_TOL, "No reneging without patience configured");
            }
            if (result.balkedCustomers != null) {
                double balked = result.balkedCustomers.get(1, 0);
                assertEquals(0.0, balked, COARSE_TOL, "No balking without balking configured");
            }
        }
