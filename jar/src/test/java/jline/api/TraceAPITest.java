...
import static jline.api.trace.TraceSkew.trace_skew;
import static jline.api.trace.Trace_var.*;
import static jline.api.trace.Trace_mean.trace_mean;
...
public class TraceAPITest {
    ...
    public void testTraceIdi_basic() {
        ...
        int[] kset = {1, 2, 3};
        jline.util.Pair<double[], int[]> result = trace_idi(data, kset, null, 1);
