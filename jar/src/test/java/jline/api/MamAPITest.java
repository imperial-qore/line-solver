...
import static jline.api.mam.Mmpp2_fit.*;
import static jline.api.mam.Mmpp2_fit1.*;
import static jline.api.mam.Map2_fit.*;
import static jline.api.mam.Aph_fit.*;
import static jline.api.mam.Aph2_adjust.*;
import static jline.api.mam.Amap2_fit_gamma.*;
import static jline.api.mam.Mamap2m_coefficients.*;
import jline.util.Pair;
import jline.api.mam.Mamap2m_coefficients.Mamap2mCoefficients;
import static jline.api.nc.Me_oqn.*;
...
public class MamAPITest {
    ...
    public void testMamap2mCan1Coefficients_basic() {
        ...
        try {
            Mamap2mCoefficients result = mamap2m_can1_coefficients(h1, h2, r1, r2);
            assertNotNull(result, "mamap2m_can1_coefficients should return a result");

            Matrix G = result.first;
            Matrix U = result.second;
            Matrix Y = result.third;
