...
public class QsysGeoGeo1Test {
    ...
    public void pmfNormalizesInBothConventions() {
        for (GeoGeo1Convention conv : GeoGeo1Convention.values()) {
            for (double[] pt : GRID) {
                GeoGeo1Result r = Qsys_geogeo1.qsys_geogeo1(pt[0], pt[1], conv);
                double mass = 0.0;
    ...
    public void conventionsDifferByExactlyOneSlot() {
        for (double[] pt : GRID) {
            GeoGeo1Result las = Qsys_geogeo1.qsys_geogeo1(pt[0], pt[1], GeoGeo1Convention.LAS_DA);
            GeoGeo1Result eas = Qsys_geogeo1.qsys_geogeo1(pt[0], pt[1], GeoGeo1Convention.EAS);
    ...
    public void lasDaIsTheDefaultConvention() {
        GeoGeo1Result def = Qsys_geogeo1.qsys_geogeo1(0.2, 0.5);
        GeoGeo1Result las = Qsys_geogeo1.qsys_geogeo1(0.2, 0.5, GeoGeo1Convention.LAS_DA);
    ...
    public void vanishingLoadLeavesOnlyTheServiceTime() {
        double s = 0.4;
        GeoGeo1Result las = Qsys_geogeo1.qsys_geogeo1(1e-9, s, GeoGeo1Convention.LAS_DA);
        GeoGeo1Result eas = Qsys_geogeo1.qsys_geogeo1(1e-9, s, GeoGeo1Convention.EAS);
    ...
    public void deterministicUnitServiceNeverQueues() {
        ...
        for (double a : new double[]{0.05, 0.3, 0.7, 0.99}) {
            GeoGeo1Result r = Qsys_geogeo1.qsys_geogeo1(a, 1.0, GeoGeo1Convention.LAS_DA);
    ...
    public void lasDaMatchesBruteForceChain() {
        for (double[] pt : GRID) {
            ...
            GeoGeo1Result r = Qsys_geogeo1.qsys_geogeo1(a, s, GeoGeo1Convention.LAS_DA);
    ...
    public void easMatchesBruteForceChain() {
        for (double[] pt : GRID) {
            ...
            GeoGeo1Result r = Qsys_geogeo1.qsys_geogeo1(a, s, GeoGeo1Convention.EAS);
    ...
    public void unstableAndOutOfRangeParametersThrow() {
        assertThrows(IllegalArgumentException.class,
                () -> Qsys_geogeo1.qsys_geogeo1(0.5, 0.5), "a = s is not stable");
        assertThrows(IllegalArgumentException.class,
                () -> Qsys_geogeo1.qsys_geogeo1(0.7, 0.5), "a > s is not stable");
        assertThrows(IllegalArgumentException.class,
                () -> Qsys_geogeo1.qsys_geogeo1(0.0, 0.5), "a must be positive");
        assertThrows(IllegalArgumentException.class,
                () -> Qsys_geogeo1.qsys_geogeo1(0.2, 1.5), "s must not exceed one");
        assertThrows(IllegalArgumentException.class,
                () -> Qsys_geogeo1.qsys_geogeo1(1.2, 1.0), "a must not exceed one");
        assertThrows(IllegalArgumentException.class,
                () -> Qsys_geogeo1.qsys_geogeo1(0.2, 0.5, null), "convention is required");
        assertThrows(IllegalArgumentException.class,
                () -> Qsys_geogeo1.qsys_geogeo1(0.2, 0.5).pmf(-1), "queue length must be non-negative");
    }
    ...
    private static GeoGeo1Result analyze(double[] pt, GeoGeo1Convention conv) {
        return Qsys_geogeo1.qsys_geogeo1(pt[0], pt[1], conv);
    }
