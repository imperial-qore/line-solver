...
public class MCAPITest {
    ...
    public void testCtmcSolve_simpleGenerator() {
        ...
        try {
            Matrix pi = CTMCSolve.ctmcSolve(Q, 1e-14);
    ...
    public void testDtmcSolve_simpleTransition() {
        ...
        try {
            Matrix pi = DTMCSolve.dtmcSolve(P, 1e-14);
    ...
    public void testCtmcSolve_precision() {
        ...
        try {
            ...
            Matrix pi1 = CTMCSolve.ctmcSolve(Q, 1e-6);
            Matrix pi2 = CTMCSolve.ctmcSolve(Q, 1e-14);
    ...
    void testCtmcMakeinfgen_validGenerator() {
        ...
        Matrix result = Ctmc_makeinfgen.ctmc_makeinfgen(Q);
    ...
    void testDtmcSolve_simpleChain() {
        ...
        Matrix pi = Dtmc_solve.dtmc_solve(P);
        assertNotNull(pi);
