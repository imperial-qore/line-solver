...
import jline.api.measures.Ms_anderson_darling;
import jline.api.measures.Ms_cramer_von_mises;
import jline.api.measures.Ms_kolmogorov_smirnov;
import jline.api.measures.Ms_kuiper;
import jline.api.measures.Ms_wasserstein;
...
public class MeasuresCoverageTest {
    ...
    void testAndersonDarling() {
        ...
        double ad = Ms_anderson_darling.ms_anderson_darling(sample1, sample2);
        ...
        double adDiff = Ms_anderson_darling.ms_anderson_darling(sample1, sample3);
    ...
    void testKolmogorovSmirnov() {
        ...
        double ks = Ms_kolmogorov_smirnov.ms_kolmogorov_smirnov(sample1, sample2);
        ...
        double ksDiff = Ms_kolmogorov_smirnov.ms_kolmogorov_smirnov(sample1, sample3);
    ...
    void testCramerVonMises() {
        ...
        double cvm = Ms_cramer_von_mises.ms_cramer_von_mises(sample1, sample2);
        ...
        double cvmDiff = Ms_cramer_von_mises.ms_cramer_von_mises(sample1, sample3);
    ...
    void testWasserstein() {
        ...
        double ws = Ms_wasserstein.ms_wasserstein(sample1, sample2);
        ...
        double wsDiff = Ms_wasserstein.ms_wasserstein(sample1, sample3);
    ...
    void testKuiper() {
        ...
        double kuiper = Ms_kuiper.ms_kuiper(sample1, sample2);
        ...
        double kuiperDiff = Ms_kuiper.ms_kuiper(sample1, sample3);
    ...
    void testMultiColumnSamples() {
        ...
        assertEquals(0.0, Ms_kolmogorov_smirnov.ms_kolmogorov_smirnov(sample1, sample2), LOOSE_FINE_TOL);
        assertEquals(0.0, Ms_wasserstein.ms_wasserstein(sample1, sample2), LOOSE_FINE_TOL);
        assertEquals(0.0, Ms_kuiper.ms_kuiper(sample1, sample2), LOOSE_FINE_TOL);
        assertEquals(0.0, Ms_cramer_von_mises.ms_cramer_von_mises(sample1, sample2), LOOSE_FINE_TOL);
        assertEquals(0.0, Ms_anderson_darling.ms_anderson_darling(sample1, sample2), LOOSE_FINE_TOL);
    }
}
