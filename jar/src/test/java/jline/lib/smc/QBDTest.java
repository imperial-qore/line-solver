...
public class QBDTest {
    ...
    public void testQBD_IS_simpleCase() {
        ...
        try {
            Map<String, Matrix> result = QBD_IS.QBD_IS(A0, A1, A2, null, null, null, null);
    ...
    public void testQBD_IS_schurMode() {
        ...
        try {
            Map<String, Matrix> result = QBD_IS.QBD_IS(A0, A1, A2, 50, 0, "Schur", 0);
    ...
    public void testQBD_FI_basicIteration() {
        ...
        try {
            Map<String, Matrix> result = QBD_FI.QBD_FI(A0, A1, A2, null, null, null, null, null);
    ...
    public void testQBD_FI_uBasedMode() {
        ...
        try {
            Map<String, Matrix> result = QBD_FI.QBD_FI(A0, A1, A2, 10000, 0, "U-Based", null, 0);
    ...
    public void testQBD_FI_naturalMode() {
        ...
        try {
            Map<String, Matrix> result = QBD_FI.QBD_FI(A0, A1, A2, 10000, 0, "Natural", null, 0);
    ...
    public void testQBD_LR_basicReduction() {
        ...
        try {
            Map<String, Matrix> result = QBD_LR.QBD_LR(A0, A1, A2, null, null, null, null);
    ...
    public void testQBD_LR_shiftMode() {
        ...
        try {
            Map<String, Matrix> result = QBD_LR.QBD_LR(A0, A1, A2, 50, 0, "Shift", 0);
    ...
    public void testQBD_LR_basicMode() {
        ...
        try {
            Map<String, Matrix> result = QBD_LR.QBD_LR(A0, A1, A2, 50, 0, "Basic", 0);
    ...
    public void testQBD_methodConsistency() {
        ...
        try {
            ...
            Map<String, Matrix> resultFI = QBD_FI.QBD_FI(A0_fi, A1_fi, A2_fi, 10000, 0, "U-Based", null, 0);

            // Run LR method
            Matrix A0_lr = qbd[0].copy();
            Matrix A1_lr = qbd[1].copy();
            Matrix A2_lr = qbd[2].copy();
            Map<String, Matrix> resultLR = QBD_LR.QBD_LR(A0_lr, A1_lr, A2_lr, 50, 0, null, 0);
    ...
    public void testQBD_maxIterations() {
        ...
        try {
            ...
            Map<String, Matrix> result = QBD_FI.QBD_FI(A0, A1, A2, 5, 0, null, null, 0);
    ...
    public void testQBD_verboseMode() {
        ...
        try {
            ...
            Map<String, Matrix> result = QBD_LR.QBD_LR(A0, A1, A2, 50, 1, null, 0);
