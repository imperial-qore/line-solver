...
public class LTITest {
    ...
    public void testGetomegaHandlesOddN() {
        ...
        BigDecimal[] result_odd = gaverstehfest.getomega(11);  // Odd n
        BigDecimal[] result_even = gaverstehfest.getomega(10); // Even n
    ...
    public void testGetalphaNeedstEvenN() {
        ...
        BigDecimal[] result_odd = gaverstehfest.getalpha(11);  // Odd n
        BigDecimal[] result_even = gaverstehfest.getalpha(10); // Even n
    ...
    public void testAlgorithmConsistency() {
        ...
        BigDecimal[] omega_12 = gaverstehfest.getomega(12);
        BigDecimal[] alpha_12 = gaverstehfest.getalpha(12);
        
        BigDecimal[] omega_11 = gaverstehfest.getomega(11); // Should behave like 10
        BigDecimal[] alpha_11 = gaverstehfest.getalpha(11); // Should behave like 10
        
        BigDecimal[] omega_10 = gaverstehfest.getomega(10);
        BigDecimal[] alpha_10 = gaverstehfest.getalpha(10);
