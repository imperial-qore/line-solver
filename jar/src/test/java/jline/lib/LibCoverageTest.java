...
public class LibCoverageTest {
    ...
    void testEuler() {
        // Test getalpha
        ArrayList<Complex> alpha = euler.getalpha(5);
        assertNotNull(alpha);
    ...
    void testTalbot() {
        // Test getalpha
        ArrayList<Complex> alpha = talbot.getalpha(5);
        assertNotNull(alpha);
        assertEquals(5, alpha.size());
        ...
        // Test getomega
        ArrayList<Complex> omega = talbot.getomega(5, alpha);
        assertNotNull(omega);
        assertEquals(5, omega.size());
    }
    ...
    void testLaguerre() {
        ...
        double[] coeffs = laguerre.getLaguerreCoefficients(5);
        ...
        double[] roots = laguerre.getLaguerreRoots(coeffs);
        assertNotNull(roots);
    ...
    void testCmeHelpers() {
        ...
        ArrayList<Double> copy = jline.lib.lti.cme.deepcopy(original);
        assertNotNull(copy);
        ...
        ArrayList<Double> randoms = jline.lib.lti.cme.getnormalrandom(10);
        assertNotNull(randoms);
        assertEquals(10, randoms.size());

        // Test binaryCheck
        boolean[] binary = jline.lib.lti.cme.binaryCheck(5, 4);  // 5 = 101 in binary
