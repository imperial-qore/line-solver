...
import static jline.lib.m3a.M3aFit.*;
import static jline.lib.m3a.M3aCompress.*;
import static jline.api.mam.Mmap_isfeasible.*;
import static jline.api.mam.Map_mean.*;
import static jline.api.mam.Map_scv.*;
import static jline.api.mam.Map_lambda.*;
import static jline.api.mam.Mmap_lambda.*;
import static jline.api.mam.Mmap_forward_moment.*;
import static jline.api.mam.Mmap_backward_moment.*;
