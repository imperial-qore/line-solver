...
public class FJCdfRespTTest {
    ...
    public void testExponentialK1() {
        ...
        FJPercentileResult result = MainFJ.mainFJ(
            arrival,
            service,
            percentiles,
            1,  // K=1
        ...
        assertArrayEquals(new double[]{50.0, 90.0, 95.0, 99.0}, result.percentiles, COARSE_TOL);
    ...
    public void testStabilityCheck() {
        ...
        assertThrows(IllegalArgumentException.class, () -> {
            MainFJ.mainFJ(arrival, service, percentiles, 1, 100, "NARE");
