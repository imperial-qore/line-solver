...
import jline.lib.butools.map.MAP2FromMoments;
...
import jline.lib.butools.ph.CheckPHRepresentation;
...
import jline.lib.butools.HankelMomsFromMoms;
import jline.lib.butools.MomsFromHankelMoms;
import jline.lib.butools.NormMomsFromMoms;
...
import jline.lib.butools.mam.FluidSolve;
import jline.lib.butools.mam.FluidSolve.FluidSolution;
...
public class BUToolsParityTest {
    ...
    public void testMAP2FromMoments_Example() {
        ...
        jline.util.Pair<Matrix, Matrix> result = MAP2FromMoments.map2FromMoments(moms, corr);
        ...
        double[] computedMoms = MarginalMomentsFromMAP.marginalMomentsFromMAP(D0, D1, 3);
        ...
        double[] computedCorr = LagCorrelationsFromMAP.lagCorrelationsFromMAP(D0, D1, 1);
    ...
    public void testCheckMAPRepresentation_ValidExample() {
        ...
        boolean flag = CheckMAPRepresentation.checkMAPRepresentation(D0, D1, 1e-14);
    ...
    public void testCanonicalFromMAP2_Example() {
        ...
        jline.util.Pair<Matrix, Matrix> result = CanonicalFromMAP2.canonicalFromMAP2(D0, D1, 1e-14);
        ...
        boolean valid = CheckMAPRepresentation.checkMAPRepresentation(D0c, D1c, 1e-14);
    ...
    public void testPH2From3Moments_Example1() {
        ...
        PH2Representation ph2 = PH2From3Moments.ph2From3Moments(moms, 1e-14);

        assertNotNull(ph2);
        assertNotNull(ph2.alpha);
        assertNotNull(ph2.A);
        assertEquals(1, ph2.alpha.getNumRows());
        assertEquals(2, ph2.alpha.getNumCols());
        assertEquals(2, ph2.A.getNumRows());
        assertEquals(2, ph2.A.getNumCols());

        // Verify moments are preserved
        double[] computedMoms = MomentsFromME.momentsFromPH(ph2.alpha, ph2.A, 3);
        assertEquals(moms[0], computedMoms[0], MID_TOL);
        assertEquals(moms[1], computedMoms[1], MID_TOL);
        assertEquals(moms[2], computedMoms[2], MID_TOL);
    }
    ...
    public void testCheckPHRepresentation_SizeMismatch() {
        ...
        boolean valid = CheckPHRepresentation.checkPHRepresentation(alpha, A, 1e-14);
    ...
    public void testFactorialMomsFromMoms_Example_DISABLED() {
        ...
        Matrix factMoms = FactorialMomsFromMoms.factorialMomsFromMoms(moms);
        ...
        Matrix recoveredMoms = MomsFromFactorialMoms.MomsFromFactorialMoms(factMoms);
        for (int i = 0; i < momsArray.length; i++) {
    ...
    public void testReducedMomsFromMoms_Example() {
        ...
        Matrix reduced = ReducedMomsFromMoms.reducedMomsFromMoms(moms);
        ...
        Matrix recoveredMoms = MomsFromReducedMoms.momsFromReducedMoms(reduced);
        for (int i = 0; i < momsArray.length; i++) {
            assertEquals(momsArray[i], recoveredMoms.get(0, i), MID_TOL);
        }
    }
    ...
    public void testHankelMomsFromMoms_Example() {
        ...
        Matrix hankel = HankelMomsFromMoms.hankelMomsFromMoms(moms);
        ...
        Matrix recoveredMoms = MomsFromHankelMoms.momsFromHankelMoms(hankel);
        for (int i = 0; i < momsArray.length; i++) {
            assertEquals(momsArray[i], recoveredMoms.get(0, i), MID_TOL);
        }
    }
    ...
    public void testNormMomsFromMoms_Example() {
        ...
        double[] normMoms = NormMomsFromMoms.NormMomsFromMoms(momsArray);
        ...
        Matrix recoveredMoms = MomsFromNormMoms.momsFromNormMoms(normMomsMatrix);
        for (int i = 0; i < momsArray.length; i++) {
            assertEquals(momsArray[i], recoveredMoms.get(0, i), MID_TOL);
        }
    }
    ...
    public void testAPHFrom3Moments_Example1() {
        ...
        APH aph = APHFrom3Moments.APHFrom3Moments(moms, 100, 1e-14);
        ...
        // Verify moments are preserved
        double[] computedMoms = MomentsFromME.momentsFromPH(alpha, T, 3);
        assertEquals(moms[0], computedMoms[0], MID_TOL);
        assertEquals(moms[1], computedMoms[1], MID_TOL);
        assertEquals(moms[2], computedMoms[2], MID_TOL);
    }
    ...
    public void testMEFromMoments_Example() {
        ...
        MERepresentation me = MEFromMoments.meFromMoments(moms);
        ...
        // Verify moments are preserved
        double[] computedMoms = MomentsFromME.momentsFromME(me.getAlpha(), me.getA(), 5);
    ...
    public void testMEFromMoments_Order2() {
        ...
        // Verify moments are preserved
        double[] computedMoms = MomentsFromME.momentsFromME(me.getAlpha(), me.getA(), 3);
        for (int i = 0; i < moms.length; i++) {
            assertEquals(moms[i], computedMoms[i], MID_TOL,
                    "Moment " + (i+1) + " mismatch");
        }
    ...
    public void testMMAPPH1FCFS_SojournTimeMoments() {
        ...
        java.util.Map<String, java.util.Map<Integer, Matrix>> result =
            MMAPPH1FCFS.MMAPPH1FCFS(D, sigma, S, null, null, 3, null, false, false, 1e-10, null);
    ...
    public void testMMAPPH1NPPR_SojournTimeMoments() {
        ...
        java.util.Map<String, java.util.Map<Integer, Matrix>> result =
            MMAPPH1NPPR.MMAPPH1NPPR(D, sigma, S, null, null, 3, null, 1e-10, 200, null);
    ...
    public void testMMAPPH1PRPR_SojournTimeMoments() {
        ...
        java.util.Map<String, java.util.Map<Integer, Matrix>> result =
            MMAPPH1PRPR.MMAPPH1PRPR(D, sigma, S, null, null, 3, null, 1e-10, 200, null);
    ...
    public void testMMAPPH1NPPR_QueueLengthMoments() {
        ...
        java.util.Map<String, java.util.Map<Integer, Matrix>> result =
            MMAPPH1NPPR.MMAPPH1NPPR(D, sigma, S, 3, null, null, null, 1e-10, 200, null);
    ...
    public void testMMAPPH1PRPR_QueueLengthMoments() {
        ...
        java.util.Map<String, java.util.Map<Integer, Matrix>> result =
            MMAPPH1PRPR.MMAPPH1PRPR(D, sigma, S, 3, null, null, null, 1e-10, 200, null);
    ...
    public void testPRPR_vs_NPPR_SojournTimeComparison() {
        ...
        java.util.Map<String, java.util.Map<Integer, Matrix>> npprResult =
            MMAPPH1NPPR.MMAPPH1NPPR(D, sigma, S, null, null, 1, null, 1e-10, 200, null);

        // Get PRPR sojourn time moments
        java.util.Map<String, java.util.Map<Integer, Matrix>> prprResult =
            MMAPPH1PRPR.MMAPPH1PRPR(D, sigma, S, null, null, 1, null, 1e-10, 200, null);
    ...
    public void testFluidFundamentalMatrices_Example() {
        ...
        java.util.Map<String, Matrix> result = FluidFundamentalMatrices.FluidFundamentalMatrices(
    ...
    public void testFluidSolve_Example() {
        ...
        FluidSolution result = FluidSolve.fluidSolve(Fpp, Fpm, Fmp, Fmm, 1e-14);

        assertNotNull(result, "Result should not be null");
        assertNotNull(result.mass0, "mass0 should not be null");
        assertNotNull(result.ini, "ini should not be null");
        assertNotNull(result.K, "K should not be null");
        assertNotNull(result.clo, "clo should not be null");

        Matrix mass0 = result.mass0;
        Matrix ini = result.ini;
        Matrix K = result.K;
        Matrix clo = result.clo;
    ...
    public void testGeneralFluidSolve_Example() {
        ...
        GeneralFluidSolution result = GeneralFluidSolve.generalFluidSolve(Q, R, null, 1e-14);
    ...
    public void testFluFluQueue_Srv0StopFalse() {
        ...
        FluFluResult result = FluFluQueue.fluFluQueue(Qin, Rin, Qout, Rout, false, 5, 5, 1e-14);
    ...
    public void testFluFluQueue_Srv0StopTrue() {
        ...
        FluFluResult result = FluFluQueue.fluFluQueue(Qin, Rin, Qout, Rout, true, 5, 5, 1e-14);
