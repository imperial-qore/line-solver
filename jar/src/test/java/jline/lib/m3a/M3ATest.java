...
public class M3ATest {
    ...
    public void testMomentComputation() {
        ...
        Double[] moments1 = M3aUtils.computeMoments(sampleMMAP, 1);
        Double[] moments2 = M3aUtils.computeMoments(sampleMMAP, 2);
        Double[] moments3 = M3aUtils.computeMoments(sampleMMAP, 3);
    ...
    public void testAutocorrelationComputation() {
        ...
        Double[] acf = M3aUtils.computeAutocorrelation(sampleMMAP, 5);
    ...
    public void testCoefficientOfVariation() {
        ...
        double cv = M3aUtils.computeCoeffVar(sampleMMAP);
    ...
    public void testIDCComputation() {
        ...
        double idc1 = M3aUtils.computeIDC(sampleMMAP, 1.0);
        double idc2 = M3aUtils.computeIDC(sampleMMAP, 2.0);
    ...
    public void testSpectralGapComputation() {
        ...
        double spectralGap = M3aUtils.computeSpectralGap(sampleMMAP);
    ...
    public void testKLDivergence() {
        ...
        double kl = M3aUtils.computeKLDivergence(sampleMMAP, mmap2, 1000, 23000);
        ...
        double selfKL = M3aUtils.computeKLDivergence(sampleMMAP, sampleMMAP, 1000, 23000);
    ...
    public void testParameterOptimization() {
        ...
        M3aUtils.ObjectiveFunction objective = params -> {
            double x = params[0];
            double y = params[1];
        ...
        // Constraint: x >= 0, y >= 0
        M3aUtils.ConstraintFunction[] constraints = new M3aUtils.ConstraintFunction[2];
        constraints[0] = params -> params[0]; // x >= 0
        constraints[1] = params -> params[1]; // y >= 0
        
        Double[] result = M3aUtils.optimizeParameters(initialParams, objective, constraints, 1e-6);
    ...
    public void testMmapValidation() {
        // Test valid MMAP
        assertTrue(M3aUtils.validateMMAP(sampleMMAP), "Sample MMAP should be valid");
        
        // Test invalid MMAP - empty
        MatrixCell emptyMMAP = new MatrixCell();
        assertFalse(M3aUtils.validateMMAP(emptyMMAP), "Empty MMAP should be invalid");
        
        // Test invalid MMAP - only D0
        MatrixCell incompleteMAP = new MatrixCell();
        incompleteMAP.set(0, sampleMMAP.get(0));
        assertFalse(M3aUtils.validateMMAP(incompleteMAP), "Incomplete MMAP should be invalid");
        ...
        assertFalse(M3aUtils.validateMMAP(mismatchedMMAP), "Mismatched dimensions should be invalid");
        ...
        assertFalse(M3aUtils.validateMMAP(invalidDiagMMAP), "Positive diagonal in D0 should be invalid");
        ...
        assertFalse(M3aUtils.validateMMAP(negativeOffDiagMMAP), "Negative off-diagonal in D0 should be invalid");
        ...
        assertFalse(M3aUtils.validateMMAP(negativeD1MMAP), "Negative elements in D1 should be invalid");
    }
    ...
    public void testEdgeCases() {
        ...
        assertTrue(M3aUtils.validateMMAP(oneDimMMAP), "1x1 MMAP should be valid");
        
        Double[] moments = M3aUtils.computeMoments(oneDimMMAP, 2);
        assertTrue(moments[0] > 0, "1x1 MMAP should have positive first moment");
        
        double cv = M3aUtils.computeCoeffVar(oneDimMMAP);
        assertTrue(cv > 0, "1x1 MMAP should have positive coefficient of variation");
        
        double spectralGap = M3aUtils.computeSpectralGap(oneDimMMAP);
