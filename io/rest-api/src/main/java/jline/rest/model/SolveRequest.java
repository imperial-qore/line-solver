...
public class SolveRequest {
    ...
    /**
     * The solver to use.
     * Supported values: mva, ctmc, fluid, jmt, nc, ssa, ln, lqns, ldes
     */
    ...
    public String validate() {
        ...
        String[] validSolvers = {"mva", "ctmc", "fluid", "jmt", "nc", "ssa", "ln", "lqns", "ldes"};
        ...
        if (!validSolver) {
            return "Invalid solver: " + solver + ". Valid solvers: mva, ctmc, fluid, jmt, nc, ssa, ln, lqns, ldes";
        }
        ...
        if ("lqnx".equals(format) || "xml".equals(format)) {
            ...
            String[] jsimSolvers = {"mva", "ctmc", "fluid", "jmt", "nc", "ssa", "ldes"};
            boolean compatible = false;
            ...
            if (!compatible) {
                return "Solver '" + solver + "' is not compatible with format '" + format + "'. " +
                       "Valid solvers for JSIM: mva, ctmc, fluid, jmt, nc, ssa, ldes";
            }
        }
