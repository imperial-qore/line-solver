package jline.solvers.taussa.state;

import java.util.*;
import java.util.stream.Collectors;
import java.util.stream.Stream;

public class FCFSBuffer extends SSAStateCell {
    /*
            FCFSClassBuffer -
    ...
    public FCFSBuffer(int nClasses, int nServers, PhaseList phaseList) {
    ...
    public FCFSBuffer(int nClasses, int nServers) {
    ...
    public SSAStateCell createCopy() {
        FCFSBuffer copyBuffer = new FCFSBuffer(this.inQueue.length, this.nServers, this.phaseList.createCopy());
