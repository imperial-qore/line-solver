...
class TestGettingStarted(unittest.TestCase):
    ...
    def test_tut08_respt_cdf(self):
        self.run_notebook("tut08_respt_cdf.ipynb")

    def test_tut09_opt_load_balancing(self):
        self.run_notebook("tut09_opt_load_balancing.ipynb")

    def test_tut10_dep_process_analysis(self):
        self.run_notebook("tut10_dep_process_analysis.ipynb")
