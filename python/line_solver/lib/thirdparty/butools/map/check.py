...
# 'verbose' is required as well: every rejection branch below reads
# butools.verbose, so omitting it turned a False result into an AttributeError.
from .. import checkInput, checkPrecision, verbose
