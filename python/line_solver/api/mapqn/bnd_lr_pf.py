...
def mapqn_bnd_lr_pf(params: PFParameters, objective_queue: int = 1,
                    sense: str = 'min') -> MapqnSolution:
    """
    ...
    # sense='min' is the classical LR lower bound; 'max' gives the matching
    # upper bound over the same LP relaxation.
