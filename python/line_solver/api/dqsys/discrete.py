...
References:
    Original MATLAB: matlab/src/api/dqsys/dqsys_geogeo1.m, dqsys_geoxgeo1.m
...
__all__ = ['dqsys_geogeo1', 'dqsys_geoxgeo1', 'dqsys_geoxgeo1_moments']
...
def dqsys_geogeo1(a: float, s: float, convention: str = LAS_DA) -> Dict[str, object]:
    """
    ...
    Returns:
        dict with keys:
            ...
            - analyzer: 'dqsys_geogeo1'

    Example:
        >>> r = dqsys_geogeo1(0.2, 0.5)
...
def dqsys_geoxgeo1(a: float, beta: float, s: float,
    ...
    and the result equals :func:`dqsys_geogeo1`.
    ...
    Returns:
        dict, see :func:`dqsys_geoxgeo1_moments`

    Example:
        >>> r = dqsys_geoxgeo1(0.1, 0.5, 0.9)
    ...
    return dqsys_geoxgeo1_moments(a, batch_mean, batch_second_factorial, s, convention)


def dqsys_geoxgeo1_moments(a: float, batch_mean: float, batch_second_factorial: float,
