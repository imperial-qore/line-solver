...
def fluid_ode_pnorm(
    ...
    # see _kb/06-solver-catalog.md (Fluid: "Symbolic drift and Jacobian",
    # FineTol placement) for why this offset must match pnorm_ode exactly.
    from ....constants import GlobalConstants
    sum_x_Qa = SQ @ x + GlobalConstants.FineTol
