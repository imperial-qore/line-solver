...
class MNAOpenAlgorithm(MAMAlgorithm):
    ...
    def solve(self, sn, options=None) -> MAMResult:
        ...
        # MNA iteration (SCV fixed point), driven by the generic DA driver
        def mna_sweep(scv_prev, iteration):
        ...
        _, iteration, _ = da_fpi(mna_sweep, scv.copy(), max_iter, tol, nanstop=True)
