...
def fj_is_homogeneous(sn: NetworkStruct) -> FJValidationResult:
    """
    ...
    for that): most fork-join models fail this predicate. The homogeneous class
    that FJ_codes solves requires:
    ...
    if sn.rt is not None:
        ...
        # Expected topology: Source -> Fork -> Queues -> Join -> Sink.
        # Simplified check only (geometry check above is the main criterion);
        # does not verify routing probabilities sum to 1 fork-to-queues.
        pass
