...
class SolverAuto(NetworkSolver):
    ...
    def _select_solver_heuristic(self) -> str:
        ...
        # Finite capacity regions: the analytical solvers reject FCRs (Region
        # feature) and JMT is the reference solver that honors them.
        if getattr(self.model, '_regions', None):
            return 'JMT'
    ...
    def isStochastic(self):
        ...
        return any(name in ('JMT', 'SSA', 'LDES') for name in (self._candidate_solvers or []))
