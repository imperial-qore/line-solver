...
def tget(table, *argv):
    if len(argv) == 1:
        ...
        elif isinstance(argv[0], line_solver.lang.OpenClass) or isinstance(argv[0], line_solver.lang.ClosedClass):
        ...
        elif isinstance(argv[1], line_solver.lang.OpenClass) or isinstance(argv[1], line_solver.lang.OpenClass):
            station = argv[0].obj.getName()
