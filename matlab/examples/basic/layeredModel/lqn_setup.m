% example of layered model with a task paying setup and delay-off times
fprintf(1, 'Example of layered model with a task paying setup and delay-off times\n');
...
T2 = SetupTask(model, 'F2', 6, SchedStrategy.FCFS).on(P2).setThinkTime(Exp.fitMean(8.0));
