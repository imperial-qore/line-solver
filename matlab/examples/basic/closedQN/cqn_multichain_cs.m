...
options.keep = true;
options.verbose = 1;
options.seed = 23000;   % fixed seed/samples for cross-codebase SSA parity
options.samples = 2e5;   % the Background chain (2 jobs, lowest visit rate) still carried a ~5% SSA standard error at 5e4, at the parity tolerance
