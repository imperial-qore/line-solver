...
% If this call is re-enabled, keep SolverMVA's own iter_tol (1e-6): the generic
% Solver.defaultOptions value (1e-4) stops the AMVA fixed point early.
%mvaOptions = options; mvaOptions.iter_tol = SolverMVA.defaultOptions.iter_tol;
