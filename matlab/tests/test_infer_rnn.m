...
for n=1:2
 %% define model
 model = infer_quick_model_rnn(false, {SchedStrategy.PS, SchedStrategy.PS, SchedStrategy.PS, SchedStrategy.PS, SchedStrategy.PS}, [[150, 30, 90, 45, 60]], [20, 40, 60, 20, 35], [100]);
