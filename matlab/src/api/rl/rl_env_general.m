classdef rl_env_general < handle
    ...
    properties
        ...
        actionSpace;                                                        % cell array indexed by node: actionSpace{key} = [idx1, ..., idxn]; nodes{key} has a dispatch policy to node{idxi}
    end
    
    methods
        function obj = rl_env_general(model, idxOfQueueInNodes, idxOfActionNodes, stateSize, gamma) 
            ...
            obj.actionSpace = cell(1, size(model.connections, 1));
