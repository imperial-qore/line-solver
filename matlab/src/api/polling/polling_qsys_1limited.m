...
%
% Approximate mean waiting time solution of a polling system with open
% arrivals. All queues use 1-limited service.
%
% Unlike the exhaustive and gated formulas of this package, no exact
% closed form is available for 1-limited service, so the result below is
% an approximation and can deviate by more than 10% from the exact
% solution (SolverCTMC, which supports arbitrary K).
%
