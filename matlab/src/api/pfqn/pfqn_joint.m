...
if nargin<5
    ...
    lGn = lGN;   % the 5th argument was declared and then never read: the body
                 % used lGn, assigned only in the branch above, so the
                 % documented cost-saving call errored with "Undefined function
                 % or variable 'lGn'".
end
if size(n,2)==1
