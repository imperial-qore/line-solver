...
codegen -config cfg pfqn_lldsingle -args {L_type, N_type, mat_type}
codegen -config cfg pfqn_ldmx_ec -args {vec_type, L_type, mat_type}
...
% pfqn_ab_amva - Skipped (dynamic struct/array growth not supported in codegen)
