%{ @file fj_is_homogeneous.m
 %  @brief Checks for a single fork-join pair with homogeneous parallel branches
 %
...
%{
 ...
 % the homogeneous class on which the FJ_codes tail approximation of Qiu, Perez
 % and Harrison (IFIP Performance 2015) is defined, i.e. the requirements:
 ...
 % <table>
 % <tr><th>Name<th>Description
 % <tr><td>isHomogeneous<td>True if network is valid FJ topology for FJ_codes
...
%}
function [isHomogeneous, fjInfo] = fj_is_homogeneous(sn)
