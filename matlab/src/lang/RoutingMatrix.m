classdef RoutingMatrix < Copyable
    ...
    methods
        ...
        function varargout = subsref(self,s)
            switch s(1).type
                case '.'
                    % obj.PropertyName and nested forms all delegate to builtin
                    [varargout{1:nargout}] = builtin('subsref',self,s);
                case '()'
                    % obj(indices) and nested forms all delegate to builtin
                    [varargout{1:nargout}] = builtin('subsref',self,s);
                case '{}'
                    % obj{indices} and nested forms delegate to builtin on rt
        ...
        function self = subsasgn(self,s,varargin)
            ...
            switch s(1).type
                case '.'
                    % obj.PropertyName = ... and nested forms delegate to builtin
