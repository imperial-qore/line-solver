classdef MarkedMAP < MarkovModulated
    ...
    methods
        ...
        function self = MarkedMAP(D,K)
            ...
            % Copy all K+2 params {D0, D1, D11, ..., D1K} into the process
            % cell (M3A layout); copying only K entries would truncate the
            % per-mark matrices and break D(1,k)/getNumberOfTypes.
            MarkedMAP = cell(1,K+2);
            for k=1:K+2
