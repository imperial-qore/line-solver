...
function ri = mva_fj_find_paths(sn, P, start, endNode, r, toMerge, QN, TN, currentTime, fjclassmap, fjforkmap, nonfjmodel)
    if start == endNode
    ...
    for i=find(P(start, :))
        ...
        if sn.nodetype(i) == NodeType.ID_FORK
            ...
            paths = mva_fj_find_paths(sn, P, i, joinIdx, r, [toMerge,s], QN, TN, 0, fjclassmap, fjforkmap, nonfjmodel);
            lambdai = 1./paths;
            d0 = 0;
            ...
            ri = [ri, mva_fj_find_paths(sn, P, joinIdx, endNode, r, toMerge, QN, TN, currentTime + d0, fjclassmap, fjforkmap, nonfjmodel)];
        else
            ri = [ri, mva_fj_find_paths(sn, P, i, endNode, r, toMerge, QN, TN, currentTime + qLen/tput, fjclassmap, fjforkmap, nonfjmodel)];
        end
    end
end