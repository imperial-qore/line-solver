...
if nargin >= 4 && ~isempty(method) && ~strcmpi(method, 'default')
    ...
    [PercRT, PercTable] = getPerctRespT@NetworkSolver(self, percentiles, jobclass, method);
    return
end
...
% Percentiles are a solve by-product, require a prior solve; see _kb/06-solver-catalog.md for rationale
