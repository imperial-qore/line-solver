...
if procid_ir == ProcessType.ID_DISABLED
...
elseif procid_ir == ProcessType.ID_IMMEDIATE
...
elseif procid_ir == ProcessType.ID_PH || procid_ir == ProcessType.ID_APH || procid_ir == ProcessType.ID_COXIAN || (phases_ir>2 && procid_ir == ProcessType.ID_HYPEREXP) %|| (phases_ir>2 && procid_ir == ProcessType.ID_COXIAN) || (phases_ir>2 && procid_ir == ProcessType.ID_HYPEREXP)
...
elseif procid_ir == ProcessType.ID_MAP
    serviceTimeStrategyNode.setAttribute('classPath', 'jmt.engine.NetStrategies.ServiceStrategies.ServiceTimeStrategy');
    serviceTimeStrategyNode.setAttribute('name', 'ServiceTimeStrategy');
    distributionNode = simDoc.createElement('subParameter');
