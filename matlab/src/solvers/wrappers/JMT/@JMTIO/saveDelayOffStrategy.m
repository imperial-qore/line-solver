...
for r = 1:K
    ...
    % [0] of it (Server.java:1281), so the strategy must sit inside a
    % single-element array rather than directly under the class.
    classRowNode = simDoc.createElement('subParameter');
    classRowNode.setAttribute('array', 'true');
    classRowNode.setAttribute('classPath', 'jmt.engine.NetStrategies.ServiceStrategy');
    classRowNode.setAttribute('name', 'delayOffTime');
    ...
    subParamNode.setAttribute('name', 'ServiceTimeStrategy');
    ...
    classRowNode.appendChild(subParamNode);
    delayOffParamNode.appendChild(classRowNode);
end
...
for r = 1:K
    ...
    classRowNode.setAttribute('array', 'true');
    classRowNode.setAttribute('classPath', 'jmt.engine.NetStrategies.ServiceStrategy');
    classRowNode.setAttribute('name', 'setUpTime');
    ...
    classRowNode.appendChild(subParamNode);
    setupParamNode.appendChild(classRowNode);
end
