...
%}
            ...
            switch options.method
                ...
                case {'aba.upper','aba.lower','bjb.upper','bjb.lower','gb.upper','gb.lower', ...
                        'pb.upper','pb.lower','sb.upper','sb.lower','mwba.upper','mwba.lower', ...
                        'pbh.upper','pbh.lower', ...
                    ...
                    options.method = erase(options.method,'ba.');
                    result = SolverBA(model, options);
