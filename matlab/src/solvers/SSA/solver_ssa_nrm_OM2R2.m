...
[t, X, ~, reactCache] = next_reaction_method(S, D, a, nvec0, samples, options, reactCache, hashfun);
...
% ======================================================================
function [t, nvecout, kfire, reactcache] = next_reaction_method(S, D, a, nvec0, samples, options, reactcache, hashfun)
