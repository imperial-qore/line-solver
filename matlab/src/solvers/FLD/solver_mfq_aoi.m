function [QN, UN, RN, TN, xvec_it, QNt, UNt, TNt, xvec_t, t, iters, runtime, aoiResults] = solver_mfq_aoi(sn, options)
...
% Mean service time = -sigma * S^{-1} * ones (bufferless and single-buffer coincide)
sigma = aoiParams.sigma;
S = aoiParams.S;
