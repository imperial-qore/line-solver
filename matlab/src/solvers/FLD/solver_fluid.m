...
%% initialization
% Wall-clock time budget (options.timeout, seconds; Inf = no budget). The ODE
% iteration in solver_fluid_iteration breaks when toc(Tstart) > max_time.
...
switch options.method
    case {'tbi','fluid.tbi'}
        [xvec_it, xvec_t, t, iters] = solver_fluid_tbi_iteration(sn, N, Mu, Phi, PH, rt, S, xvec_it, ydefault, slowrate, Tstart, max_time, options);
    otherwise
