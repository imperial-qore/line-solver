function [QN,UN,RN,TN,xvec_it,QNt,UNt,TNt,xvec_t,t,iters,runtime] = solver_mfq(sn, options)
    ...
    for k = 1:K
        if isinf(sn.njobs(k))
            ...
            if is_simple_exponential
                ...
                line_warning(mfilename, 'MFQ requires Markov-modulated arrival or service, switching to analytical formulas.');
