...
% PH stays unassigned when neither the exact nor the approximate search finds
% anything, and MATLAB then reports the opaque "Output argument PH not
% assigned" from inside this function. Return an empty result instead and let
% the caller decide, as the other kpctoolbox fitters do.
PH = {};
