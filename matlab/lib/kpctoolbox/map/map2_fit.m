...
if h2==0
    if h3==0 && g2==0
        ...
        ERR=0;
        return   % without this the Poisson answer just built fell through to
                 % the h2 out-of-bounds branch below, which overwrote it with
                 % MAP={} and ERR=30. Map2_fit.java reproduces the same fall-through.
    else
        MAP={};
