function [FIT] = mmpp2_fitc_approx(a, bt1, bt2, binf, m3t2, ...
    t1, t2)
...
%fprintf('M3(t2): input = %.3f, output = %.3f\n', m3t2, fm3t2);
   ...
   function obj = compute_obj (l1,l2,r1,r2)
        ...
        if (t1 ~= t2)
            ...
            % At t1 == t2 the second index of dispersion coincides with the
            % first; without this xbt2 is left unassigned and xm3t2 below
            % errors on it.
            xbt2 = xbt1;
        end
