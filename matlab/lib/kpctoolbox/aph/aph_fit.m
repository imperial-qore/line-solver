...
% Exponential moment set (scv==1 with matching third moment) is a degeneracy
% for the general APH(2) case formulas; the exponential is a valid phase-type
scv = (e2-e1^2)/e1^2;
if abs(scv-1) < GlobalConstants.FineTol && abs(e3 - 6*e1^3) < GlobalConstants.FineTol
    APH = map_exponential(e1);
    return
end
n2 = e2/e1^2;
