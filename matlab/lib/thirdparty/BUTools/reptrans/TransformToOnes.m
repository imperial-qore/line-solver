...
%
% Returns the similarity transformation matrix that 
% converts the given column vector to a vector of ones.
% It works even if clovec has zero entries.
% 
% Parameters
% ----------
...
% -------
% B : matrix, shape(M,M)
%     The matrix by which B*clovec = ones holds  
