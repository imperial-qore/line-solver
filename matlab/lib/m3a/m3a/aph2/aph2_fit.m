...
%        m3a_printf('Fitting APH(2): %d approximate solutions\n', length(APHS));
%        m3a_printf('Fitting APH(2): M2 = %f -> %f\n', M2, M2a);
%        m3a_printf('Fitting APH(2): M3 = %f -> %f\n', M3, M3a);
    end
else
%    m3a_printf('Fitting APH(2): %d exact solutions\n', length(APHS));
end
