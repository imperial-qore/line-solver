function [fit,m3pps] = m3pp_interleave_fitc_theoretical(MMAP, t, tinf, mapping)
...
m3a_printf('Fitting %d classes with %d M3PP(2,m_j) processes\n', m, k);
...
[fit,m3pps] = m3pp_interleave_fitc(av, btv, binfv, ...
