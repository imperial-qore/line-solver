function [FIT] = maph2m_fitc_approx(a, bt1, binf, t1, ...
                                         ai, dvt3, t3)
...
lb = [1e-6, 1e-6, 1e-6];
ub = [inf, inf, inf];
m3a_printf('Fitting unified counting process...\n');
if strcmp(method_d0d1,'exact')
    FIT = aph2_fitc(a, bt1, binf, t1);
...
m3a_printf('Unified fitting error: %f\n', ferror);
m3a_printf('Rate: input = %.3f, output = %.3f\n', a, fa);
m3a_printf('IDC(t1): input = %.3f, output = %.3f\n', bt1, fbt1);
m3a_printf('IDC(inf): input = %.3f, output = %.3f\n', binf, fbinf);
