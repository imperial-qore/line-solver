...
This repository includes the MATLAB version of the [LINE solver](https://sourceforge.net/p/line-solver/code/ci/master). A MATLAB version of the [manual](https://sourceforge.net/p/line-solver/code/ci/master/blob/main/doc/LINE-matlab.pdf) includes getting started information.
